      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-md p-8 space-y-8 animate-fade-in">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link to="#" className="text-sm text-azul-colonial-600 hover:text-azul-colonial-700">
                  Esqueceu a senha?
                </Link>
              </div>
              <input
        ...
        <div className="text-center mt-8 border-t border-gray-200 pt-6">
          ...
          <p className="text-xs text-gray-500 mt-1">
            <strong>Usuário regular:</strong> usuario@teste.com / senha123
          </p>
          <p className="text-xs text-gray-500 mt-1">
            <strong>Administrador:</strong> admin@teste.com / senha123
          </p>
        </div>
      </div>
    </div>
