...
public class JpaPropertyRepositoryTest {
    ...
    class SelectAvailablePropertiesByPeriod {
        ...
        void setup() {
            ...
            p1 = EntityBuilder.createProperty("f0d6c22f-3e9a-44c4-b4b5-fd67e5edacfc", "Apartamento Central", "Apartamento de 2 quartos no centro da cidade", admin, "1500", "101", "Rua da Liberdade", "São Paulo", "SP", "01000-000");
            p2 = EntityBuilder.createProperty("8dfc6c64-1e7b-4ec1-8450-d20e160c7093", "Casa de Praia", "Casa de frente para o mar", admin, "2500", "202", "Rua da Liberdade", "Rio de Janeiro", "RJ", "22000-000");
            p3 = EntityBuilder.createProperty("6a1f9b3e-0d42-4a6d-ae7d-12b50a0b9c77", "Cobertura Luxuosa", "Cobertura com vista panorâmica", admin, "3500", "303", "Av. Paulista", "São Paulo", "SP", "01311-000");
            p4 = EntityBuilder.createProperty("b8de4a91-e9d9-4f6a-9481-ccf74cf71b01", "Sítio Tranquilo", "Sítio com lago e área verde", admin, "1200", "1", "Estrada do Campo", "Campinas", "SP", "13000-000");
            p5 = EntityBuilder.createProperty("c51f5172-bc2c-4bb4-9841-12b3933c94e0", "Flat Executivo", "Flat próximo ao centro financeiro", admin, "1800", "405", "Rua Augusta", "São Paulo", "SP", "01413-000");
            p6 = EntityBuilder.createProperty("25f913ed-0326-4633-b4ac-32b9477c3edb", "Chalé na Montanha", "Chalé com lareira e vista para as montanhas", admin, "1400", "99", "Alameda das Neves", "Campos do Jordão", "SP", "12460-000");
            p7 = EntityBuilder.createProperty("84e89a9a-2c9e-4ec1-8904-112b679e4715", "Estúdio Moderno", "Estúdio compacto e funcional", admin, "1000", "12", "Rua Bela Cintra", "São Paulo", "SP", "01415-000");
            p8 = EntityBuilder.createProperty("d30a5ae6-df95-42d0-8c5f-5e1a10f7f2ea", "Casa na Serra", "Casa aconchegante na serra", admin, "1600", "77", "Estrada da Serra", "Petrópolis", "RJ", "25680-000");
            p9 = EntityBuilder.createProperty("3fa11c74-79cc-499f-9f08-3e1f1c1d66e2", "Apartamento Beira-Mar", "Apartamento com varanda de frente para o mar", admin, "2200", "501", "Av. Atlântica", "Rio de Janeiro", "RJ", "22070-000");
            p10 = EntityBuilder.createProperty("4efb93c6-263d-47c1-9e38-e40a4d2d9627", "Loft Industrial", "Loft com decoração industrial e open space", admin, "2000", "888", "Rua Harmonia", "São Paulo", "SP", "05435-000");
            p11 = EntityBuilder.createProperty("a1c2b3d4-e5f6-7890-1234-567890abcdef", "Casa Histórica", "Casa charmosa no centro histórico", admin, "1900", "50", "Rua das Flores", "Ouro Preto", "MG", "35400-000");
            p12 = EntityBuilder.createProperty("b2c3d4e5-f6a7-8901-2345-67890abcdef0", "Fazenda com Gado", "Ampla fazenda para pecuária e lazer", admin, "4000", "S/N", "Rodovia do Gado", "Campo Grande", "MS", "79000-000");
            p13 = EntityBuilder.createProperty("c3d4e5f6-a7b8-9012-3456-7890abcdef12", "Bangalô na Lagoa", "Bangalô com acesso direto à lagoa", admin, "2800", "10", "Avenida Beira Mar", "Florianópolis", "SC", "88000-000");
            p14 = EntityBuilder.createProperty("d4e5f6a7-b8c9-0123-4567-890abcdef34", "Loja Comercial", "Espaço amplo para comércio", admin, "3000", "123", "Praça Central", "Salvador", "BA", "40000-000");
            p15 = EntityBuilder.createProperty("e5f6a7b8-c9d0-1234-5678-90abcdef56", "Apartamento de Luxo", "Apartamento com acabamento de alto padrão", admin, "5000", "1500", "Rua da Alta", "Belo Horizonte", "MG", "30000-000");
            p16 = EntityBuilder.createProperty("f6a7b8c9-d0e1-2345-6789-0abcdef789", "Chácara Arborizada", "Chácara com vasta área verde e piscina", admin, "1700", "20", "Estrada da Água", "Goiânia", "GO", "74000-000");
